        ...
        return response()->json([
            ...
            'data' => $items->map(function (TrueFalseQuestion $item) use ($user): array {
                $quizData = [
                    ...
                    'correct_answer_index' => (int) $item->getRawOriginal('correct_answer'),
                    'correct_answer' => (string) $item->getRawOriginal('correct_answer') === '0',
                    'correctAnswer' => (string) $item->getRawOriginal('correct_answer') === '0',
                    'quizType' => 'true_false',
