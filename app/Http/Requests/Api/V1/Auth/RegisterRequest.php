...
class RegisterRequest extends BaseFormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'specialized_subject_id' => ['nullable', 'integer', 'exists:specialized_subjects,id'],
            'education_system' => ['nullable', 'string', 'in:general,languages'],
            'city_or_address' => ['nullable', 'string', 'max:255'],
