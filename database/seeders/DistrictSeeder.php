...
class DistrictSeeder extends Seeder
{
    ...
    {
        $districts = [
            ['governorate_id' => 1, 'name_ar' => '15 مايو', 'name_en' => '15 May'],
            ...
            ['governorate_id' => 3, 'name_ar' => 'سيدى بشر', 'name_en' => 'Sidi Bishr'],
            ...
            ['governorate_id' => 3, 'name_ar' => 'سيدي جابر', 'name_en' => 'Sidi Gaber'],
            ...
            ['governorate_id' => 3, 'name_ar' => 'سيدي كرير', 'name_en' => 'Sidi Kerir'],
            ...
            ['governorate_id' => 4, 'name_ar' => 'بني عبيد', 'name_en' => 'Bani Ubaid'],
            ['governorate_id' => 4, 'name_ar' => 'المنزلة', 'name_en' => 'Al Manzala'],
            ['governorate_id' => 4, 'name_ar' => 'تمي الأمديد', 'name_en' => 'tami al\'amdid'],
            ...
            ['governorate_id' => 6, 'name_ar' => 'رشيد', 'name_en' => 'Rashid'],
            ...
            ['governorate_id' => 7, 'name_ar' => 'الفيوم الجديدة', 'name_en' => 'Fayoum El Gedida'],
            ...
            ['governorate_id' => 9, 'name_ar' => 'القصاصين الجديدة', 'name_en' => 'Kasasien El Gedida'],
            ...
            ['governorate_id' => 11, 'name_ar' => 'المنيا الجديدة', 'name_en' => 'Minya El Gedida'],
            ...
            ['governorate_id' => 15, 'name_ar' => 'أسوان الجديدة', 'name_en' => 'Aswan El Gedida'],
            ...
            ['governorate_id' => 16, 'name_ar' => 'أسيوط الجديدة', 'name_en' => 'Assiut El Gedida'],
            ...
            ['governorate_id' => 16, 'name_ar' => 'صدفا', 'name_en' => 'Sidfa'],
            ['governorate_id' => 17, 'name_ar' => 'بني سويف', 'name_en' => 'Bani Sweif'],
            ['governorate_id' => 17, 'name_ar' => 'بني سويف الجديدة', 'name_en' => 'Beni Suef El Gedida'],
            ...
            ['governorate_id' => 18, 'name_ar' => 'بورسعيد', 'name_en' => 'PorSaid'],
            ...
            ['governorate_id' => 20, 'name_ar' => 'الصالحية الجديدة', 'name_en' => 'El Salihia El Gedida'],
            ...
            ['governorate_id' => 21, 'name_ar' => 'رأس سدر', 'name_en' => 'Ras Sidr'],
            ...
            ['governorate_id' => 22, 'name_ar' => 'سيدي سالم', 'name_en' => 'Sidi Salm'],
            ['governorate_id' => 22, 'name_ar' => 'قلين', 'name_en' => 'Qellen'],
            ['governorate_id' => 22, 'name_ar' => 'سيدي غازي', 'name_en' => 'Sidi Ghazi'],
            ...
            ['governorate_id' => 23, 'name_ar' => 'سيدي براني', 'name_en' => 'Sidi Brani'],
            ...
            ['governorate_id' => 26, 'name_ar' => 'الشيخ زويد', 'name_en' => 'Sheikh Zowaid'],
            ...
            ['governorate_id' => 27, 'name_ar' => 'سوهاج', 'name_en' => 'Sohag'],
            ['governorate_id' => 27, 'name_ar' => 'سوهاج الجديدة', 'name_en' => 'Sohag El Gedida'],
            ['governorate_id' => 27, 'name_ar' => 'أخميم', 'name_en' => 'Akhmeem'],
            ['governorate_id' => 27, 'name_ar' => 'أخميم الجديدة', 'name_en' => 'Akhmim El Gedida'],
            ['governorate_id' => 27, 'name_ar' => 'البلينا', 'name_en' => 'Albalina'],
            ['governorate_id' => 27, 'name_ar' => 'المراغة', 'name_en' => 'El Maragha'],
            ['governorate_id' => 27, 'name_ar' => 'المنشأة', 'name_en' => 'almunsha\'a'],
            ['governorate_id' => 27, 'name_ar' => 'دار السلام', 'name_en' => 'Dar AISalaam'],
            ['governorate_id' => 27, 'name_ar' => 'جرجا', 'name_en' => 'Gerga'],
            ['governorate_id' => 27, 'name_ar' => 'جهينة الغربية', 'name_en' => 'Jahina Al Gharbia'],
            ['governorate_id' => 27, 'name_ar' => 'ساقلته', 'name_en' => 'Saqilatuh'],
            ['governorate_id' => 27, 'name_ar' => 'طما', 'name_en' => 'Tama'],
            ['governorate_id' => 27, 'name_ar' => 'طهطا', 'name_en' => 'Tahta'],
            ['governorate_id' => 27, 'name_ar' => 'الكوثر', 'name_en' => 'Alkawthar'],
        ];

        $rows = array_map(fn(array $district) => array_merge($district, [
            'created_at' => now(),
            'updated_at' => now(),
        ]), $districts);
